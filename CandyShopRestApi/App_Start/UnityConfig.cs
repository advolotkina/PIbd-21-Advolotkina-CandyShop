...
namespace CandyShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, CandyShopDbContext>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IConfectionerService, ConfectionerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<ICandyService, CandyServiceBD>(new HierarchicalLifetimeManager());
